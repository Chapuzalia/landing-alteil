...
import { IntroAnimation, INTRO_DURATION_MS } from "@/components/animations/intro-animation"
...
import { DevExSection } from "@/components/sections/devex-section"
    ...
    <div className="bg-background text-foreground min-h-screen font-sans antialiased">
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <div className="absolute inset-x-0 bottom-0 z-30 flex flex-col px-6 md:px-12 pb-12 max-w-3xl">
          ...
          >
            Streamline<br />operations.<br />Scale with<br />intelligent software.
          </h1>
          ...
          <div className="flex gap-8 sm:gap-12">
            {[
              ...
              { value: "2.4h", label: "Avg. Resolution" },
              { value: "180+", label: "Enterprises" },
            ].map((stat, i) => (
              <div
                key={i}
                style={{
              ...
              >
                <div className="text-3xl sm:text-4xl text-foreground font-light tracking-tight" style={{ fontFamily: '"Satoshi", sans-serif' }}>{stat.value}</div>
                <div className="text-xs text-foreground/40 tracking-widest uppercase mt-1" style={{ fontFamily: '"Satoshi", sans-serif' }}>{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid grid-cols-12 grid-rows-auto gap-3" onMouseMove={handleMouse}>
            ...
            <BentoCard className="col-span-12 p-8 min-h-[200px] flex flex-col justify-between relative overflow-hidden" delay={0}>
              ...
              <div
                ...
                style={{
                  background: "linear-gradient(to bottom, transparent 35%, rgb(var(--page-bg-rgb) / 0.3) 50%, rgb(var(--page-bg-rgb) / 0.75) 65%, rgb(var(--page-bg-rgb) / 0.95) 80%, var(--page-bg) 100%)",
                }}
              />
              {/* Content */}
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-light mb-3">Unified Operations Hub</h3>
                <p className="text-sm text-foreground/45 leading-relaxed max-w-sm">
                  Connect every system, team, and workflow in one place. Real dashboards, real control — no more scattered tools.
                </p>
              </div>
            </BentoCard>
            ...
            <BentoCard className="col-span-12 md:col-span-4 p-8 min-h-[200px]" delay={120}>
              ...
              <p className="text-sm text-foreground/45 leading-relaxed">Track every system and metric. Debug with full history and live operational logs.</p>
            </BentoCard>
            ...
            <BentoCard className="col-span-12 md:col-span-4 p-8 min-h-[200px]" delay={160}>
              ...
              <h3 className="text-lg font-light mb-2">Connected Data</h3>
              <p className="text-sm text-foreground/45 leading-relaxed">Unify data across every tool and department. One source of truth your teams can trust.</p>
            </BentoCard>
            ...
            <BentoCard className="col-span-12 md:col-span-4 p-8 min-h-[200px]" delay={200}>
              ...
              <p className="text-sm text-foreground/45 leading-relaxed">Define what every team and user can access. Fine-grained control across every system.</p>
            </BentoCard>
          </div>
        </div>
      </section>
      ...
      <section id="agents" className="py-32 px-6 md:px-12 lg:px-20 border-t border-foreground/[0.06]">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 mb-16">
            ...
            <p className="text-sm text-foreground/45 leading-relaxed max-w-xs">
              Start from a proven module or compose your own. Every solution is versioned, testable, and built to scale.
            </p>
          </div>
      ...
      {/* ── HOW IT WORKS ──────────────────────────────────────────────────── */}
      <section id="workflow" className="py-32 px-6 md:px-12 lg:px-20 border-t border-foreground/[0.06] overflow-hidden">
        <div className="max-w-6xl mx-auto">
          <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3" onMouseMove={handleMouse}>
            {[
              { n: "01", title: "Define",  desc: "Describe the outcome you need. Set objectives, systems, and boundaries in plain language.", delay: 0,   img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/define-5aafAmGBrxZpOqJ3XLHY3n3qzC2I5K.png" },
              { n: "02", title: "Compose", desc: "Connect systems and teams in the visual editor. Wire triggers, conditions, and outputs.", delay: 80,  img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/compose-5RT5VR4f1Y3GoFmovqTKLTG4UXp3g2.png" },
              { n: "03", title: "Test",    desc: "Run sandboxed simulations. Inspect every step in a full execution trace.", delay: 140, img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/test-zm8guZwxJHtwWsJ7XO4B0CF7GzlNK8.png" },
              { n: "04", title: "Deploy",  desc: "Ship globally in one click. Everything auto-scales, self-heals, and reports back.", delay: 200, img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/deploy-an8fgHSLzniojkcmRyGGIFQUJF9T5J.png" },
            ].map((step) => (
      ...
      {/* ── INTEGRATIONS ──────────────────────────────────────────────────── */}
      <section id="integrations" className="py-32 px-6 md:px-12 lg:px-20 border-t border-foreground/[0.06]">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 mb-16">
            <div>
            ...
            <p className="text-sm text-foreground/45 leading-relaxed max-w-xs">
              200+ native connectors, from Slack to your internal database. Build custom integrations with our SDK in minutes.
            </p>
          </div>

          {/* Full-width image block with glass cards */}
          {/* Mobile: flex-col, image + cards stacked. Desktop: image fills block, cards absolute */}
          <div className="rounded-2xl overflow-hidden border border-foreground/[0.07] flex flex-col md:block md:relative" onMouseMove={handleMouse}>
            {/* Image */}
            ...
            <div className="flex flex-col gap-3 p-4 md:absolute md:bottom-4 md:right-4 md:p-0 md:w-72">
              <div
                className="rounded-xl border border-[var(--glass-border)] p-6"
                style={{
                  backdropFilter: "blur(24px)",
                  WebkitBackdropFilter: "blur(24px)",
                  background: "rgb(var(--surface-rgb) / 0.60)",
                }}
              >
                <Tag>SDK</Tag>
                <h3 className="mt-3 text-lg font-light mb-2">Build custom integrations</h3>
                <p className="text-xs text-foreground/45 leading-relaxed mb-4">Define any function as a tool your systems can call. TypeScript and Python.</p>
                <div className="bg-foreground/[0.05] rounded-lg border border-foreground/[0.07] p-3 font-mono text-[11px] text-foreground/50 leading-relaxed">
                  <span className="text-foreground/25">// tool definition</span><br />
                  ...
                  {"  "}<span className="text-amber-700/70">run</span>: <span className="text-foreground/35">async (q) </span>={">"}<br />
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs text-foreground/40 tracking-widest">LIVE API</span>
                </div>
                <p className="text-sm text-foreground/45">Full REST + WebSocket API. Stream system outputs directly into your product.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="security" className="py-32 px-6 md:px-12 lg:px-20 border-t border-foreground/[0.06]">
        <div className="max-w-6xl mx-auto">
          <div className="mb-16">
            <PixelIcon type="platform" size={40} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <BentoCard className="p-6 lg:row-span-1" delay={0}>
              <div className="text-xs text-foreground/30 tracking-widest uppercase mb-4">Live Audit Trail</div>
              <div className="space-y-2">
                {[
                  { time: "12:34:21", action: "workflow_executed", status: "success" },
                  ...
                  <div
                    key={i}
                    className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-foreground/[0.02] hover:bg-foreground/[0.04] transition-colors border border-foreground/[0.04] group cursor-pointer"
                    style={{
      ...
      <section className="py-0 border-t border-foreground/[0.06] overflow-hidden select-none">
        <div className="flex border-b border-foreground/[0.06]" style={{ animation: "marqueeLeft 28s linear infinite" }}>
          {[...Array(3)].map((_, rep) => (
            <div key={rep} className="flex shrink-0">
              {["System Integration", "Data Sync", "Workflow Automation", "Data Analysis", "Reporting", "Scheduling", "SQL Queries", "API Calls", "File Processing", "Monitoring"].map((cap) => (
                <div key={cap} className="flex items-center gap-6 px-10 py-5 border-r border-foreground/[0.06] shrink-0">
      ...
      {/* ── LIVE AGENTS ��──────────────────────────────────────────────────── */}
      <section id="live" className="py-32 px-6 md:px-12 lg:px-20 border-t border-foreground/[0.06]">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <p className="mt-6 text-base text-foreground/40 leading-relaxed max-w-sm">
                At any moment, thousands of workflows are running across teams worldwide — connected, monitored, and reliable.
              </p>
              <div className="mt-10 flex items-end gap-2">
                <LiveAgentCounter />
                <span className="text-foreground/30 text-sm mb-1 tracking-wide">workflows running globally</span>
              </div>
            </div>
      ...
      {/* ── PRICING ───────────────────────────────────���────������─���───────────── */}
      <section id="pricing" className="py-32 px-6 md:px-12 lg:px-20 border-t border-foreground/[0.06]">
            ...
            {[
              {
                ...
                features: ["3 workspaces", "1,000 workflows/mo", "Community support", "Basic analytics"],
                delay: 0,
              },
              {
                name: "Growth",
                price: "$49",
                period: "/mo",
                sub: "For teams scaling up",
                features: ["Unlimited workspaces", "100K workflows/mo", "Priority support", "Advanced analytics", "Custom integrations", "REST API"],
                highlight: true,
                delay: 80,
              },
              {
                ...
                features: ["Unlimited everything", "Dedicated infra", "SOC 2 / HIPAA", "SLA guarantees", "SSO & SAML", "Custom contracts"],
                delay: 140,
              },
            ].map((plan) => (
              <BentoCard
                key={plan.name}
                className={`p-8 flex flex-col ${plan.highlight ? "border-foreground/20 bg-secondary" : ""}`}
                delay={plan.delay}
              >
                <div className="mb-8">
                  <div className="font-pixel text-[11px] tracking-widest text-foreground/40 mb-4">{plan.name}</div>
                  <div className="flex items-baseline gap-1 mb-1">
                    <span className="text-4xl font-light">{plan.price}</span>
                    {plan.period && <span className="text-foreground/40 text-sm">{plan.period}</span>}
                  </div>
                  <p className="text-xs text-foreground/35 tracking-wide">{plan.sub}</p>
                </div>
                <ul className="space-y-3 flex-1 mb-8">
                  {plan.features.map(f => (
                    <li key={f} className="flex items-center gap-3 text-sm text-foreground/55">
                      <div className="w-1 h-1 rounded-full bg-foreground/25 shrink-0" />
                      {f}
                    </li>
                  ))}
                </ul>
                <button className={`w-full py-3 rounded-xl text-sm tracking-widest transition-all duration-200 ${
                  plan.highlight
                    ...
                    : "border border-foreground/10 text-foreground/60 hover:border-foreground/25 hover:text-foreground hover:bg-foreground/[0.04]"
                }`}>
      ...
      {/* ── CTA ───────────────────────────────────────────────────────────── */}
      <section className="relative py-32 px-6 md:px-12 lg:px-20 border-t border-foreground/[0.06] overflow-hidden">
        ...
        <div
          className="absolute inset-0 pointer-events-none"
          style={{
                  background: "linear-gradient(to top, var(--page-bg) 0%, rgb(var(--page-bg-rgb) / 0.92) 18%, rgb(var(--page-bg-rgb) / 0.55) 35%, transparent 55%)",
          }}
        />
        <div className="relative z-10 max-w-2xl mx-auto text-center">
          <h2 className="font-heading text-4xl md:text-5xl lg:text-6xl font-light tracking-tight leading-[1.05] mb-6">
            Start streamlining<br />with Alteil.
          </h2>
          <p className="text-sm text-foreground/45 leading-relaxed mb-10">
            Join the teams using Alteil Solutions to connect systems, automate operations, and grow with measurable impact.
          </p>
          {!submitted ? (
            <form
            ...
            >
              <input
                ...
                required
                className="flex-1 bg-card border border-foreground/10 rounded-xl px-4 py-3 text-sm text-foreground placeholder:text-foreground/25 focus:outline-none focus:border-foreground/25 transition-colors"
              />
              <button
                type="submit"
                className="px-8 py-3 bg-[var(--brand-blue)] text-white text-sm rounded-xl hover:opacity-90 transition-opacity tracking-widest font-medium"
              >
                JOIN
              </button>
            </form>
      ...
      <footer className="py-10 px-6 md:px-12 lg:px-20 border-t border-foreground/[0.06]">
        ...
        <div className="max-w-6xl mx-auto mt-8 pt-6 border-t border-foreground/[0.04]">
          <span className="text-xs text-foreground/20">© 2026 Alteil Solutions. All rights reserved.</span>
        </div>
      </footer>
    </div>
  )
