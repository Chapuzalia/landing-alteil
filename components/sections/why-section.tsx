      ...
      <div className="max-w-6xl mx-auto">
        ...
        <BentoCard className="relative overflow-hidden p-0" delay={0}>
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-[0.82fr_1.18fr]" onMouseMove={handleMouse}>
            <div className="border-b border-foreground/[0.06] p-7 md:p-9 lg:border-b-0 lg:border-r">
              <Tag>{why.promise}</Tag>
            ...
            <div className="p-7 md:p-9">
              <div className="relative grid gap-0">
                <div className="absolute bottom-8 left-[15px] top-8 w-px bg-gradient-to-b from-[var(--brand-teal)]/50 via-foreground/10 to-transparent" aria-hidden="true" />
                {why.reasons.map((reason, i) => (
                  <div key={reason} className="relative grid grid-cols-[32px_1fr] gap-5 pb-8 last:pb-0">
                    <div className="relative z-10 mt-1 flex h-8 w-8 items-center justify-center rounded-full border border-[var(--brand-teal)]/25 bg-card text-[10px] font-medium tracking-widest text-foreground/55 shadow-[0_10px_30px_rgb(20_187_166_/_0.08)]">
                      {String(i + 1).padStart(2, "0")}
                    </div>
                    <div className="rounded-xl border border-foreground/[0.06] bg-background/25 px-5 py-4 backdrop-blur-sm">
